...
metrics:
  ...
  plugin-id: 0   # id с bstats.org; 0 — ничего не отправлять
```

Чтобы статистика собиралась, зарегистрируйте плагин на bstats.org и
впишите выданный числовой id. Отправляются число приватов и распределение
по типам.
